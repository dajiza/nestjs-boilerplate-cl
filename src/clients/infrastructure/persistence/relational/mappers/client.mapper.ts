...
export class ClientMapper {
  ...
  static toPersistence(domainEntity: Client): ClientEntity {
    ...
    persistenceEntity.creditCardsOnFile = domainEntity.creditCardsOnFile;
    ...
    persistenceEntity.marketingSettings = domainEntity.marketingSettings;
    ...
    persistenceEntity.reminderSettings = domainEntity.reminderSettings;
